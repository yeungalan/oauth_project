...
<br>
  <div class="ts fluid vertical buttons">
  	<a  href="main.php?url=<?php echo $_REQUEST["url"]; ?>" class="ts negative button" id="main">Main Server</a>
    <a  href="google.php?url=<?php echo $_REQUEST["url"]; ?>" class="ts warning button">Google</a>
    <a  href="github.php?redirect=1&url=<?php echo $_REQUEST["url"]; ?>" class="ts primary button">Github</a>
    <a  href="imus.php?url=<?php echo $_REQUEST["url"]; ?>" class="ts inverted button">IMUS</a>
</div>
